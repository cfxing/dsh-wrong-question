window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function GraphView({ g, onPick }) {
        ...
        return (0, jsx_runtime_1.jsxs)("div", { className: "graph-page", children: [(0, jsx_runtime_1.jsx)("h2", { children: "\u77E5\u8BC6\u56FE\u8C31" }), (0, jsx_runtime_1.jsx)("p", { children: "\u8282\u70B9\u5927\u5C0F\u4EE3\u8868\u9519\u9898\u6570\u91CF\uFF0C\u8FDE\u7EBF\u7C97\u7EC6\u4EE3\u8868\u4E24\u4E2A\u77E5\u8BC6\u70B9\u5171\u540C\u51FA\u73B0\u7684\u9891\u7387\u3002" }), layout.nodes.length ? (0, jsx_runtime_1.jsxs)("div", { className: "knowledge-map", children: [(0, jsx_runtime_1.jsxs)("svg", { viewBox: "0 0 720 480", role: "img", "aria-label": "\u77E5\u8BC6\u70B9\u5173\u7CFB\u56FE", children: [(0, jsx_runtime_1.jsx)("g", { className: "graph-lines", children: layout.edges.map((e) => (0, jsx_runtime_1.jsx)("line", { x1: e.source.x, y1: e.source.y, x2: e.target.x, y2: e.target.y, strokeWidth: Math.min(7, 1 + e.weight) }, e.source.id + '-' + e.target.id)) }), (0, jsx_runtime_1.jsx)("g", { children: layout.nodes.map((n) => (0, jsx_runtime_1.jsxs)("g", { className: "graph-vertex", role: "button", tabIndex: 0, onClick: () => onPick(n.id), onKeyDown: e => { if (e.key === 'Enter' || e.key === ' ')
                                            onPick(n.id); }, children: [(0, jsx_runtime_1.jsx)("circle", { cx: n.x, cy: n.y, r: n.r, fill: n.color }), (0, jsx_runtime_1.jsxs)("text", { x: n.x, y: n.y + n.r + 16, textAnchor: "middle", children: [n.id, " (", n.count, ")"] }), (0, jsx_runtime_1.jsxs)("title", { children: [n.id, "\uFF1A", n.count, " \u9053\uFF0C\u638C\u63E1 ", n.mastery, "%\uFF0C\u5F85\u590D\u4E60 ", n.due] })] }, n.id)) })] }), (0, jsx_runtime_1.jsxs)("aside", { children: [(0, jsx_runtime_1.jsx)("h3", { children: "\u5173\u8054\u6700\u5F3A\u7684\u77E5\u8BC6\u70B9\u5BF9" }), pairs.map((e) => (0, jsx_runtime_1.jsxs)("button", { onClick: () => onPick(e.source), children: [(0, jsx_runtime_1.jsx)("span", { children: e.source }), (0, jsx_runtime_1.jsx)("i", { children: "\u00D7" }), (0, jsx_runtime_1.jsx)("span", { children: e.target }), (0, jsx_runtime_1.jsxs)("b", { children: [e.weight, " \u6B21"] })] }, e.source + e.target)), !pairs.length && (0, jsx_runtime_1.jsx)("p", { children: "\u9700\u8981\u81F3\u5C11\u4E00\u9053\u5305\u542B\u4E24\u4E2A\u77E5\u8BC6\u70B9\u7684\u9519\u9898\u3002" })] })] }) : (0, jsx_runtime_1.jsx)("div", { className: "empty", children: "\u6DFB\u52A0\u77E5\u8BC6\u70B9\u540E\u4F1A\u751F\u6210\u5173\u7CFB\u56FE\u3002" })] });
    }
